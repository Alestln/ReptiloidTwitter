...
namespace Persistence.Migrations.Social
{
    ...
    [Migration("20240608093415_Add_FKToRefreshTokenToAccountTable")]
    partial class Add_FKToRefreshTokenToAccountTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Domain.Roles.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9b13c3e9-a4bd-4afe-a7ae-b9c60e6265e0"),
                            Title = "Admin"
                        },
                        new
                        {
                            Id = new Guid("6db03773-9569-4db5-9b83-461d6dfcffba"),
                            Title = "User"
                        });
                });
